...
export default function Home() {
  return (
    <>
      <LandingHeader />
      <main className="min-h-screen w-full bg-gradient-to-br from-[#f6faff] to-white pt-24 sm:pt-24 pb-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-start pt-16">
        {/* ======================== Hero Section ======================== */}
        <section className="w-full max-w-3xl mx-auto flex flex-col items-center text-center relative mt-12" style={{ minHeight: '520px' }}>
          {/* Floating message bubbles around headline */}
          <div className="hidden md:block absolute left-0 top-8 md:-translate-x-[95%] z-10 float-bubble float-delay-1 max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg overflow-x-auto">
          ...
          <div className="hidden md:block absolute left-1/2 top-16 md:translate-x-[110%] z-10 float-bubble float-delay-2 max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg overflow-x-auto">
            <div className="bg-white rounded-xl shadow-lg px-6 py-4 flex items-center gap-3 text-gray-500 text-base min-w-[220px]">
              <span className="inline-block h-4 w-4 bg-gray-200 rounded-full"></span>
              Still waiting to hear back from candidates
            </div>
          </div>
          <div className="hidden md:block absolute left-1/2 bottom-0 mb-8 md:-translate-x-[180%] z-10 float-bubble float-delay-3 max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg overflow-x-auto">
            <div className="bg-white rounded-xl shadow-lg px-6 py-4 flex items-center gap-3 text-gray-500 text-base min-w-[220px]">
              <span className="inline-block h-4 w-4 bg-gray-200 rounded-full"></span>
              Our best candidate just accepted another offer
            </div>
          </div>
          <div className="hidden md:block absolute left-1/2 bottom-0 mb-8 md:translate-x-[130%] z-10 float-bubble float-delay-4 max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg overflow-x-auto">
            <div className="bg-white rounded-xl shadow-lg px-6 py-4 flex items-center gap-3 text-gray-500 text-base min-w-[220px]">
              <span className="inline-block h-4 w-4 bg-gray-200 rounded-full"></span>
          ...
          {/* Main headline */}
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-gray-900 mb-4 leading-tight relative z-20">
            Every Hire, <span className="text-blue-600">Faster</span> and <span className="text-blue-700">Better</span>
          </h1>
          {/* Subheadline/description */}
          <p className="max-w-lg mx-auto text-gray-600 mb-8 sm:text-lg text-lg relative z-20">
